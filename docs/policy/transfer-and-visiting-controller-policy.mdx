...
* ***b*** A member may not hold an official staff positilf of their controlling in their home Division
* **2.3** The home Division is respon within a Region / Division where their status is only that of a Visiting Controller
* **2.2** A controller shall perform the more than haonsible for the provisions of training, assessments and ratings. A division may delegate some of this function to a sub-division operating under its control.
